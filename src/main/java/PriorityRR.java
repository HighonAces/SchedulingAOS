...
public class PriorityRR implements Algoritm {
    List<Task> taskList;
    ...
    public void schedule() throws CloneNotSupportedException {
        deepCopy();
        Collections.sort(pendingTaskList, Collections.reverseOrder());
        System.out.println("Priority with Priority Roundrobin scheduling");
